    ...
    return (
       <div className="background-style">
        ...
        <div className="mcq-box" id="mcq-form">
            ...
            <button className="badge-button"><BadgeIcon/></button>
            <button className="badge-button"><BadgeIcon/></button>
            <button className="badge-button"><BadgeIcon/></button>
            <button className="badge-button"><BadgeIcon/></button>
            <button className="badge-button"><BadgeIcon/></button>
            ...
            <div>
                <form>
                <input type="radio" id= "option1" onClick={disableRadio} style={{width:"18px", height:"18px", outline:"none", border:"0.5px solid #6d6b6b;", display:"block", alignItems:"center", marginTop:"20px"}}></input>
                ...
                <input type="radio" id= "option2" onClick={disableRadio} style={{width:"18px", height:"18px", outline:"none", border:"0.5px solid #6d6b6b;", display:"block", alignItems:"center", marginTop:"20px"}}></input>
                <input className="question-option-text"
                        style={{marginTop:"-22px"}}
                        type="text"
                        placeholder="Option 2"></input>
                
                <input type="radio" id= "option3" onClick={disableRadio} style={{width:"18px", height:"18px", outline:"none", border:"0.5px solid #6d6b6b;", display:"block", alignItems:"center", marginTop:"20px"}}></input>
                <input className="question-option-text"
                        style={{marginTop:"-22px"}}
                        type="text"
                        placeholder="Option 3"></input>
               
                <input type="radio" id= "option4" onClick={disableRadio} style={{width:"18px", height:"18px", outline:"none", border:"0.5px solid #6d6b6b;", display:"block", alignItems:"center", marginTop:"20px"}}></input>
                <input className="question-option-text"
                        style={{marginTop:"-22px"}}
                        type="text"
        ...
        <div id="buttons">
            <div id= "form-clones" style={{display:"block"}}>
                ...
                <div className="add-mcq-question-box">
                    <button className="add-question-button" onClick={duplicateShortAnswer}> + Add short answer question</button>
                </div>
            </div>
        </div>
        </div>
