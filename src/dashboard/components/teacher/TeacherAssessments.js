...
import "../../style/assessmentsTeacher.css";
import "../../fonts/font.css";

import { AssessmentItem } from '../student/assessmentItem';
...
export const TeacherAssessments = () => {
    ...
    return (
        <div className="assessments-box2">
            <label className="course-title2">Assessments</label>

            <div>
                <label className="assessment-h1-2">Date</label>
                <label className="assessment-h2-2">Class</label>
                <label className="assessment-h3-2">Time</label>
            </div>
